...
public enum ArmorsMaterials implements IArmorMaterial {
    ...
    COPPER_ARMOR(Registries.COPPER_ARMOR,  7, new int[]{1, 3, 5, 2}, 9, Ingredient.fromStacks(new ItemStack(IngotsItems.COPPER_INGOT)), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
    ALUMINIUM_ARMOR(Registries.ALUMINIUM_ARMOR,  6, new int[]{1, 2, 4, 1}, 6, Ingredient.fromStacks(new ItemStack(IngotsItems.ALUMINIUM_INGOT)), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
    LEAD_ARMOR(Registries.LEAD_ARMOR,  5, new int[]{1, 2, 4, 1}, 5, Ingredient.fromStacks(new ItemStack(IngotsItems.LEAD_INGOT)), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
    SILVER_ARMOR(Registries.SILVER_ARMOR,  15, new int[]{2, 5, 6, 2}, 25, Ingredient.fromStacks(new ItemStack(IngotsItems.SILVER_INGOT)), SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F),
    TIN_ARMOR(Registries.TIN_ARMOR, 6, new int[]{1, 2, 4, 1}, 7, Ingredient.fromStacks(new ItemStack(IngotsItems.TIN_INGOT)), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
    URANIUM_ARMOR(Registries.URANIUM_ARMOR,  12, new int[]{2, 5, 6, 2}, 9, Ingredient.fromStacks(new ItemStack(IngotsItems.URANIUM_INGOT)), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
